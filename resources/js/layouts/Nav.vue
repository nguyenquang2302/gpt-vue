<template>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            <!-- cmnd -->
            <li class="nav-item">
                <a class="nav-link" role="button" title="Lấy lịch sử giao dịch" @click="ActivityPosBack()">
            ...
            <li class="nav-item" title="Kiểm tra tiền" @click="checkAllCommand">
                <a class="nav-link" role="button">
...
const ActivityPosBack  = async() => {

await axios.post('/activitiPosback').then((response) => {
    toast.error(response.data.message);
