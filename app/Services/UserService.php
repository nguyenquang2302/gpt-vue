...
class UserService extends BaseService
{
    ...
    public function store(array $data = []): User
    {
        ...
        if($posName = $data['posName']??null) {
            $posName = preg_replace('/\s*/', '', $posName);
            $posName =strtoupper(Str::slug($posName));
        } else 
        {
            $posName = null;
        }
        ...
        try {
            ...
            $user = $this->createUser([
                ...
                'activeBank' => $data['activeBank'] ?? null,
                'passBank' => $data['passBank'] ?? null,
                'autoPosBack' => $data['autoPosBack'] ?? null,
    ...
    public function update(User $user, array $data = []): User
    {
        ...
        try {
            ...
            if(isset($data['branch_ids']) && $data['branch_ids']) {
                $user->branchs()->attach($data['branch_ids']);
            }
    ...
    protected function createUser(array $data = []): User
    {
        ...
        return $this->model::create([
            ...
            'benAccountNo' => $data['benAccountNo'],
            'activeBank' => $data['activeBank'],
            'passBank' => $data['passBank'],
            'autoPosBack' => $data['autoPosBack'] ?? null,
            'branch_id' => $data['branch_id'] ?? null,
            'posName' => $data['posName'] ?? null,
            'time_partner' => $data['time_partner'],
